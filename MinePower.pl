...
____________
SECURITY = Yes!!
By ]Creep1ng/Dr3ams] André !!

How to use : perl hokage.pl <ip or url> <time>

<ip/url> = 0.0.0.0 or URL.com
<time> = Time in seconds

<Author ]Creep1ng/Dr3ams] = André>

Example IP : perl hokage.pl 95.0.0.0 60
Example URL : perl hokage.pl site.com 60
